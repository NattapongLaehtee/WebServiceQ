                        ...
                        <li>
                          <a href="#step-3">
                            ...
                            <span class="step_descr">
                                              ...
                                              <small><h5><font color="black">ขั้นตอนการทำงาน</font></h5></small>
                                          </span>
                          </a>
                        </li>
                        <li>
                          <a href="#step-4">
                            ...
                            <span class="step_descr">
                                             <b><font color="black">ขั้นตอนที่ 4</font></b><br />
                                              <small><h5><font color="black">สิทธิ์การจองคิว</font></h5></small>
                                          </span>
                          </a>
                        </li>
                        <li>
                     ...
                     <div id="step-1">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"><font color="black">ชื่อคิว</font><span class="required"><font color="red">*</font></span>
                            </label>
