               		...
               		<div class="x_content">
                    	<div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            ...
                            <td class=" "><?php echo $row->Tool_barcode; ?></td>
                               ...
                               <td class=" "><a href="<?php echo site_url("Devices_control/opendevice/".$row->Tool_id);?>"><button type="submit" class="btn btn-success">เปิดการใช้งาน</button></a></td>
                          				</tr>
                          			<?php }?>
                        				</tbody>
                    				</table>
