                     			...
                     			action="<?php echo(site_url("Devices_control/insert_device")); ?>" method="post">
									<div class="form-group">
                        				...
                        				<div class="col-md-3 col-sm-3 col-xs-">
                          					<input type="text" id="last-name" name="devicename" required="required" value="อุปกรณ์ชุดที่  1" class="form-control col-md-7 col-xs-12">
                        				</div>
                      				</div>
                     				<div class="form-group">
                    				...
                    				<div class="form-group">
                        				...
                        				<div class="col-md-3 col-sm-3 col-xs-">
                          					<input type="text" id="barcodedevice" name="barcodedevice" maxlength="5"  required="required" class="form-control col-md-7 col-xs-12">
                       					</div>
                      				</div>
                                    <div class="form-group">
